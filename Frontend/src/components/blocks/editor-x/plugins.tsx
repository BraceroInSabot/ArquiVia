...
export const placeholder = 'Comece a digitar...'
const maxLength = 500
...
export function Plugins({ }) {
  ...
  return (
    <div className="sticky top-0 z-10 flex h-full w-full flex-col overflow-hidden rounded-lg border bg-background shadow">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex gap-1 overflow-auto border-b">
